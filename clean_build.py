...
# Read from git directly into python string (avoids powershell encoding issues)
result = subprocess.run(['git', 'show', 'f515ce8:index.html'], capture_output=True)
